...
* [Group 0](#group-0) - Mag
* [Group 1](#group-1) - Kalki, Varuna, Vrita
* [Group 2](#group-2) - Ashvinau, Marutah, Namuci, Rudra, Sumba
* [Group 3](#group-3) - Mitra, Surya, Tapas
* [Group 4](#group-4) - Asparas, Bhirava, Kaitabha, Kama, Kumara, Ushasu, Varaha, Vayu
* [Group 5](#group-5) - Deva, Durga, Garuda, Ila, Nandin, Ribhava, Rukmin, Sato, Sita, Soma, Yaksa
* [Group 6](#group-6) - Andhaka, Bana, Bhima, Kabanda, Mahu, Marica, Naga, Naraka, Pushan, Rati, Ravana
* [Group 7](#group-7) - Cell Mags, Diwari, Nidra, Savitri
...
| Item          | Synchro |   IQ |   DEF |   POW |   DEX |  MIND |
| ------------- | ------: | ---: | ----: | ----: | ----: | ----: |
...
**Stage 2:** Ashvinau, Marutah, Namuci, Rudra, Sumba
...
**Stage 3:** Andhaka, Bana, Kabanda, Mahu, Marica, Naga, Naraka, Ravana  
...
| Item          | Synchro |   IQ |   DEF |   POW |   DEX |  MIND |
| ------------- | ------: | ---: | ----: | ----: | ----: | ----: |
| Monomate      |    `-1` | `±0` |  `-4` | `+21` | `-15` |  `-5` |
| Dimate        |    `±0` | `+1` |  `-1` | `+27` | `-10` | `-16` |
| Trimate       |    `+2` | `±0` |  `+5` | `+29` |  `-7` | `-25` |
| Monofluid     |    `-1` | `±0` | `-10` |  `-5` | `-10` | `+21` |
| Difluid       |    `±0` | `+1` |  `-5` | `-16` |  `-5` | `+25` |
| Trifluid      |    `+2` | `±0` |  `-7` | `-25` |  `+6` | `+29` |
| Antidote      |    `-1` | `+1` | `-10` | `-10` | `+28` | `-10` |
| Antiparalysis |    `+2` | `-1` |  `+9` | `-18` | `+24` | `-15` |
| Sol Atomizer  |    `+2` | `+1` | `+19` | `+18` | `-15` | `-20` |
| Moon Atomizer |    `+2` | `+1` | `-15` | `-20` | `+19` | `+18` |
| Star Atomizer |    `+4` | `+2` |  `+3` |  `+7` |  `+3` |  `+3` |
